import{c as e,h as t,r as n,u as r}from"./index-CN4LivHG.js";var i=t(r(),1),a=n();function o({questions:e,moduleSlug:t}){let[n,r]=(0,i.useState)(0),[o,s]=(0,i.useState)(0),[c,l]=(0,i.useState)(null),[u,d]=(0,i.useState)(!1),[f,p]=(0,i.useState)(!1),m=e[n];function h(e){c||(l(e),d(!0),e===m.correctAnswer&&s(e=>e+1))}function g(){if(l(null),d(!1),n===e.length-1){p(!0),localStorage.setItem(`${t}-quiz-score`,o+ +(c===m.correctAnswer));return}r(e=>e+1)}function _(){r(0),s(0),l(null),d(!1),p(!1)}if(f){let t=o+ +(c===m.correctAnswer);return(0,a.jsxs)(`div`,{className:`\r
